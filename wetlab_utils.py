...
def find_opt_concentration(dataframe):
    ...
    print(f'Choosing {opt_conc} uM will give {max_corr*100}% correct wells. This is the highest percentage')
    print(f'Choosing {desired_conc[percent_90]:.2f} uM will give {frac_correct[percent_90]*100}% correct wells.' )
    print(f'Choosing {desired_conc[percent_80]:.2f} uM will give {frac_correct[percent_80]*100}% correct wells.')
