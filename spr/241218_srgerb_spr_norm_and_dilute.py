...
metadata = {
    'protocolName': '241218_srgerb_spr_norm_and_dilute',
    'author': 'srgerb',
    'apiLevel':'2.5',
...
[ ['1_C3',], [187.5], 1, 'D5', 0.000],
[ ['1_C4',], [187.5], 1, 'F5', 0.000],
[ ['1_C5',], [187.5], 1, 'H5', 0.000],
[ ['1_C6',], [187.5], 1, 'J5', 0.000],
[ ['1_C7',], [187.5], 1, 'L5', 0.000],
[ ['1_C8',], [187.5], 1, 'N5', 0.000],
[ ['1_C9',], [187.5], 1, 'P5', 0.000],
[ ['1_C10',], [187.5], 1, 'A9', 0.000],
[ ['1_C11',], [187.5], 1, 'C9', 0.000],
[ ['1_C12',], [187.5], 1, 'E9', 0.000],
[ ['1_D1',], [187.5], 1, 'G9', 0.000],
[ ['1_D2',], [187.5], 1, 'I9', 0.000],
[ ['1_D3',], [187.5], 1, 'K9', 0.000],
[ ['1_D4',], [187.5], 1, 'M9', 0.000],
[ ['1_D5',], [187.5], 1, 'O9', 0.000],
[ ['1_D6',], [187.5], 1, 'B9', 0.000],
[ ['1_D7',], [187.5], 1, 'D9', 0.000],
[ ['1_D8',], [187.5], 1, 'F9', 0.000],
[ ['1_D9',], [187.5], 1, 'H9', 0.000],
[ ['1_D10',], [187.5], 1, 'J9', 0.000],
[ ['1_D11',], [187.5], 1, 'L9', 0.000],
        ...
        for frac, vol in list(zip(fractions, frac_vol)):
            ...
            for i in range(int(dilutions)):
                ...
                if step == 'dilute':
                    ...
                    s300.aspirate(remaining_vol, frac_plates[src_p][src_w].bottom(z_off + .2))
